package com.example.AddressBook.serviceTest;

import com.example.AddressBook.dto.AuthUserDTO;
import com.example.AddressBook.dto.ContactDTO;
import com.example.AddressBook.dto.LoginDTO;
import com.example.AddressBook.entities.ContactEntity;
import com.example.AddressBook.interfaces.IAuthInterface;
import com.example.AddressBook.interfaces.IContactService;
import com.example.AddressBook.repositories.ContactRepository;
...
public class ContactServiceTest {
    ...
    public void createTest(){
        ...
        ContactDTO newContact = new ContactDTO("Aditya Gupta", "ag7023587@gmail.com", 789527336L, "Agra");
        ...
        ContactEntity foundContact = contactRepository.findByEmail("ag7023587@gmail.com");

        assertNotNull(foundContact);

        assertEquals(789527336L, foundContact.getPhoneNumber());
    ...
    public void getTest(){
        ...
        newContact = new ContactDTO("Aditya Gupta", "ag7023587@gmail.com", 789527336L, "Agra");
    ...
    public void getAllTest(){
        ...
        l1.add(new ContactDTO("Abhay Goyal", "abhay@gmail.com", 982749202L, "KacheriGhat"));
        l1.add(new ContactDTO("Divyansh Bansal", "divyansh@gmail.com", 982749202L, "KamlaNagar"));
    ...
    public void editTest(){
        ...
        //edit the previous contact with new one
        ContactDTO editContact = new ContactDTO("Dhruv Agarwal", "dhruv@gmail.com", 982755502L, "Agra", resDto1.getId());
